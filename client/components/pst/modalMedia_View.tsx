...
const ModalMedia_View = ({ extractImageSrc, currentImageIndex, setCurrentImageIndex, closeModal, selectedPost, cmntCnt, fakeComments, toggledMenuPostId }) => {
...
export default ModalMedia_View;